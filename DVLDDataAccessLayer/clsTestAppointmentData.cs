    ...
    public class clsTestAppointmentData
    {
        public static bool GetTestAppointmentByID(int TestAppointmentID, ref int TestTypeID, ref int LocalDrivingLicenseApplicationID, ref DateTime AppointmentDate,  ref float PaidFees, ref int CreatedByUserID,ref bool IsLocked,ref int RetakeTestApplicationID)
        {
            ...
            catch (Exception ex)
            {
                ...
                string Location = "clsTestAppointmentData → GetTestAppointmentByID";
            ...
            ref float PaidFees, ref int CreatedByUserID, ref bool IsLocked, ref int RetakeTestApplicationID)
        {
            ...
            catch (Exception ex)
            {
                ...
                string Location = "clsTestAppointmentData → GetLastTestAppointment";
                clsEventLogger.LogEvent(ex, Location, System.Diagnostics.EventLogEntryType.Error);
        ...
        public static DataTable GetAllTestAppointments()
        {
            ...
            catch (Exception ex)
            {
                ...
                string Location = "clsTestAppointmentData → GetAllTestAppointments";
                clsEventLogger.LogEvent(ex, Location, System.Diagnostics.EventLogEntryType.Error);
        ...
        public static DataTable GetAllTestAppointmentsForTestTypeForApplication(int LocalDrivingLicenseApplicationID, int TestTypeID)
        {
            ...
            catch (Exception ex)
            {
                ...
                string Location = "clsTestAppointmentData → GetAllTestAppointmentsForTestTypeForApplication";
                clsEventLogger.LogEvent(ex, Location, System.Diagnostics.EventLogEntryType.Error);
        ...
        public static int AddNewTestAppointment(int TestTypeID,  int LocalDrivingLicenseApplicationID,  DateTime AppointmentDate,  float PaidFees,  int CreatedByUserID,  bool IsLocked,  int RetakeTestApplicationID)
        {
          ...
          Values ( @TestTypeID,@LocalDrivingLicenseApplicationID,@AppointmentDate, @PaidFees,@CreatedByUserID,@IsLocked,@RetakeTestApplicationID);
            ...
            catch (Exception ex)
            {
                ...
                string Location = "clsTestAppointmentData → AddNewTestAppointment";
                clsEventLogger.LogEvent(ex, Location, System.Diagnostics.EventLogEntryType.Error);
        ...
        public static bool UpdateTestAppointment(int TestAppointmentID,int TestTypeID, int LocalDrivingLicenseApplicationID, DateTime AppointmentDate, float PaidFees,  int CreatedByUserID, bool IsLocked, int RetakeTestApplicationID)
        {
            ...
            catch (Exception ex)
            {
                ...
                string Location = "clsTestAppointmentData → UpdateTestAppointment";
                clsEventLogger.LogEvent(ex, Location, System.Diagnostics.EventLogEntryType.Error);
        ...
        public static int GetTestID(int TestAppointmentID)
        {
            ...
            catch (Exception ex)
            {
                ...
                string Location = "clsTestAppointmentData → GetTestID";
                clsEventLogger.LogEvent(ex, Location, System.Diagnostics.EventLogEntryType.Error);
        ...
        public static bool LockTestAppointment(int TestAppointmentID)
        {
            int rowsAffected = 0;
            SqlConnection connection = new SqlConnection(clsDataAccessSettings.ConnectionString);
            string query = " Update TestAppointmts SET IsLocked = 1 where TestAppointmentID=@TestAppointmentID";
            SqlCommand command = new SqlCommand(query, connection);
            command.Parameters.AddWithValue("@TestAppointmentID", TestAppointmentID);
            try
            {
            ...
            {
                string Location = "clsTestAppointmentData → LockTestAppointment";
                clsEventLogger.LogEvent(ex, Location, System.Diagnostics.EventLogEntryType.Error);
        ...
        public static bool IsTestAppintmentLocked(int TestAppointmentID)
        {
            bool locked = false;
            SqlConnection connection = new SqlConnection(clsDataAccessSettings.ConnectionString);
            string query = " select TestAppointments.IsLocked from TestAppointments where TestAppointmentID=@TestAppointmentID";
            SqlCommand command = new SqlCommand(query, connection);
            command.Parameters.AddWithValue("@TestAppointmentID", TestAppointmentID);
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                string Location = "clsTestAppointmentData → IsTestAppintmentLocked";
                clsEventLogger.LogEvent(ex, Location, System.Diagnostics.EventLogEntryType.Error);
